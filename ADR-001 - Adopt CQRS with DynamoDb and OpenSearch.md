...
Cons
Search functionality becomes increasingly complex
Read and write workloads compete for the same resources
Scaling strategy becomes less flexible
DynamoDB Only
Pros
Simplest AWS-native solution
Lowest operational overhead
Cons
Limited query flexibility
Complex secondary index management
...
Cons
Not designed to be the authoritative transactional store
...
Define and monitor projection latency SLAs.
